<template>
    ...
    <div class="work"><div class="topic">Title designs</div><div class="caption">Practiced transliteration title works to my mother tongue</div><div class="imageslab"> <img src="../assets/titleworks.png" alt="imageslab"/></div></div>
    <div class="work"><div class="topic">Poster designs</div><div class="caption">As part of my passion project, I imagined and designed posters</div><div class="imageslab"> <img src="../assets/posterworks.png" alt="imageslab"/></div></div>
